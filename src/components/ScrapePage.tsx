...
const APIFY_ACTORS = [
  // ===== 超高价值渠道（直接返回邮箱+电话）=====
  {
    id: 'pipelinelabs/lead-scraper-apollo-zoominfo-lusha',
    name: 'Pipeline Leads (强烈推荐)',
    platform: 'pipeline_leads',
    icon: Rocket,
    color: 'bg-gradient-to-r from-purple-600 to-pink-600',
    supportsEmail: true,
    supportsPhone: true,
    emailRate: '极高',
    description: '90M+验证数据库！$1/千条，类似Apollo/ZoomInfo/Lusha，每次最多50k条',
    pricing: '$1/千条',
    category: 'premium',
  ...
  },
  {
    ...
    supportsPhone: true,
    emailRate: '高',
    description: '直接返回验证邮箱+电话！可按职位、行业、公司规模筛选',
    pricing: '$1.5/千条',
    category: 'premium',
    needEmailExtract: false,
  },
  {
    id: 'fatihtahta/lead-finder-with-emails-scraper',
    name: 'Lead Finder Pro',
    platform: 'lead_finder_pro',
    icon: Search,
    color: 'bg-emerald-600',
    supportsEmail: true,
    supportsPhone: true,
    emailRate: '高',
    description: '验证邮箱+电话，$1.39/千条，替代Apollo/ZoomInfo',
    pricing: '$1.39/千条',
    category: 'premium',
    needEmailExtract: false,
  },
  {
    id: 'fatihai-tools/leads-finder',
    name: 'Multi-Source Leads',
    platform: 'multi_source_leads',
    icon: Globe,
    color: 'bg-teal-600',
    supportsEmail: true,
    supportsPhone: true,
  ...
  },
  {
    ...
    supportsPhone: false,
    emailRate: '邮箱发现',
    description: '按职位搜索人物+邮箱发现',
    pricing: '$5/千条',
    category: 'high_value',
    needEmailExtract: false,
  },
  {
    id: 'apimaestro/linkedin-companies-search-scraper',
    name: 'LinkedIn 公司搜索 (推荐)',
    platform: 'linkedin_companies',
    icon: Linkedin,
    color: 'bg-blue-600',
    supportsEmail: false,
    supportsPhone: false,
    emailRate: '需配合邮箱提取',
    description: '支持产品/行业关键词搜索公司！如"铝型材"、"aluminum profile"',
    pricing: '$5/千条',
    category: 'high_value',
  ...
  {
    id: 'scraper-mind/linkedin-email-scraper',
    name: 'LinkedIn 邮箱提取 (推荐)',
    platform: 'linkedin_email',
    icon: Linkedin,
    color: 'bg-sky-600',
    supportsEmail: true,
    supportsPhone: false,
    emailRate: '直接提取',
    description: '支持产品/行业关键词搜索人物+直接提取邮箱！',
    pricing: '$5/月+用量',
    category: 'high_value',
    needEmailExtract: false,
    badge: '产品关键词',
